    ...
    def _browse_url(self, url: str) -> str:
        ...
        try:
            ...
            response = requests.get(
                url, proxies=self.tor_proxy, headers=headers, timeout=30
            )
        ...
        try:
            ...
            for engine in search_engines:
                try:
                    ...
                    response = requests.get(
                        search_url, proxies=self.tor_proxy, headers=headers, timeout=30
                    )
...
research_tools = [TorBrowserTool(), OSINTTool(), WebScrapingTool()]
