...
class WadeWebInterface:
    ...
    def process_request_async(self, session_id: str, user_input: str):
        ...
        try:
            ...
            socketio.emit('thinking', {'status': 'Wade crew is analyzing your request...'}, room=session_id)
...
def handle_query(data):
    ...
    thread = threading.Thread(
        target=wade_interface.process_request_async,
        args=(session_id, user_input)
    )
    thread.daemon = True
    thread.start()
