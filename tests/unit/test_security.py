...
class TestCertificateHandler:
    ...
    def test_create_server_certificate(self, cert_handler):
        ...
        success = cert_handler.create_server_certificate('test.example.com', ['192.168.1.1'])
    ...
    def test_check_certificate_expiry(self, cert_handler):
        ...
        expiry_info = cert_handler.check_certificate_expiry(cert_handler.server_cert_path)
