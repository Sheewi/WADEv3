...
def create_wade_model():
    ...
    try:
        ...
        result = subprocess.run(['ollama', 'pull', BASE_MODEL], capture_output=True, text=True)
...
"""
        ...
        result = subprocess.run(['ollama', 'create', WADE_MODEL, '-f', str(modelfile_path)], 
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Wade CrewAI - Uncensored AI Assistant')
