...
class TaskRouter:
    ...
    def execute_plan(self, action_plan: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.elite_few.log_and_respond(f"Executing plan: {action_plan['description']}", component="TASK_ROUTER")
    ...
    def _execute_step(self, agent_name: str, action: str, params: Dict[str, Any]) -> Dict[str, Any]:
        """
