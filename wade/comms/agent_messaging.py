...
class AgentMessaging:
    ...
    def broadcast_message(self, from_agent: str, message: Dict[str, Any], exclude: Optional[List[str]] = None) -> Dict[str, bool]:
        """
    ...
    def get_messages(self, agent_id: str, max_messages: int = 10, block: bool = False, timeout: Optional[float] = None) -> List[Dict[str, Any]]:
        """
    ...
    def get_message_history(self, agent_id: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
        """
        Get message history.
