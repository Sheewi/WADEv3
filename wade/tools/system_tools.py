...
def tool_execute_command(elite_few, command: str, timeout: int = 30, shell: bool = False) -> Dict[str, Any]:
    """
...
def tool_write_file(elite_few, path: str, content: str, mode: str = 'w') -> Dict[str, Any]:
    """
    Write to a file.
