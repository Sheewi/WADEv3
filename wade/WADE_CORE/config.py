...
class ConfigManager:
    ...
    def _setup_environment(self):
        ...
        # Set WADE_HOME
        os.environ['WADE_HOME'] = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        ...
        os.environ['WADE_RUNTIME'] = os.path.abspath(os.path.join(os.path.dirname(self.config_path), runtime_dir))
        
        # Set WADE_LOGS
        logs_dir = self.get('paths', {}).get('logs_dir', '../WADE_RUNTIME/logs')
        os.environ['WADE_LOGS'] = os.path.abspath(os.path.join(os.path.dirname(self.config_path), logs_dir))
        
        # Set WADE_TEMP
        temp_dir = self.get('paths', {}).get('temp_dir', '../WADE_RUNTIME/temp')
        os.environ['WADE_TEMP'] = os.path.abspath(os.path.join(os.path.dirname(self.config_path), temp_dir))
        
        # Set WADE_DATA
        data_dir = self.get('paths', {}).get('data_dir', '../datasets')
        os.environ['WADE_DATA'] = os.path.abspath(os.path.join(os.path.dirname(self.config_path), data_dir))
