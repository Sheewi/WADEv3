...
class WADE_OS_Core:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        # Set up logging
        self.logger = setup_logging(self.config.get('system', {}).get('log_level', 'INFO'))
    ...
    def _initialize_components(self):
        ...
        self.elite_few.console_parser = ConsoleParser(self.elite_few, self.elite_few.cli_handler)
        ...
        if self.config.get('interface', {}).get('gui', {}).get('enabled', True):
            ...
            self.elite_few.gui = initialize_gui(self.elite_few, self.elite_few.cli_handler, host, port)
    ...
    def _main_loop(self):
        ...
        welcome_message = render_text_template('welcome', 
