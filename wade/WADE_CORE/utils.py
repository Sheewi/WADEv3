...
def create_directories(paths: Dict[str, str]):
    ...
    runtime_dir = os.path.abspath(
        os.path.join(base_dir, paths.get("runtime_dir", "WADE_RUNTIME"))
    )
    os.makedirs(runtime_dir, exist_ok=True)

    # Create logs directory
    logs_dir = os.path.abspath(
        os.path.join(base_dir, paths.get("logs_dir", "WADE_RUNTIME/logs"))
    )
    os.makedirs(logs_dir, exist_ok=True)

    # Create temp directory
    temp_dir = os.path.abspath(
        os.path.join(base_dir, paths.get("temp_dir", "WADE_RUNTIME/temp"))
    )
    os.makedirs(temp_dir, exist_ok=True)

    # Create data directory
    data_dir = os.path.abspath(
        os.path.join(base_dir, paths.get("data_dir", "datasets"))
    )
